...
export default function Home() {
  ...
  const HomeDescription =
    "Every modern user works alongside AI and Dexio LabX designs Human<>AI systems that deliver real value inside SaaS products.";
  return (
    <main className="bg-[#0B0C0E] text-white min-h-screen selection:bg-purple-500/30 overflow-x-hidden">
      <div className="relative">
        ...
        <section className="relative max-w-6xl mx-auto px-6 text-center flex flex-col items-center pt-36 pb-12 md:pt-[180px] md:pb-[144px] z-20">
          <div className="flex flex-col items-center">
            ...
            <h1
              className="text-[30px] md:text-[48px] font-[600] pb-0 tracking-[0%] leading-[40px] md:leading-[60px]"
              style={{ color: "#F1F2F4", fontFamily: "Sora, sans-serif" }}
            >
              Designing for SaaS that is
            </h1>
            <h2
              className="text-[30px] md:text-[48px] font-[600] tracking-[0%] md:tracking-[1px] leading-[1.2] md:leading-tight inline-block bg-gradient-to-tr from-[#6366f1] via-[#a855f7] via-[#c34772] to-[#f9f916] bg-clip-text text-transparent"
            ...
            <p
              className="mt-4 md:mt-[12px] max-w-3xl text-center font-inter text-[14px] md:text-base font-normal leading-[150%] md:leading-6 px-0 md:px-0"
              style={{ color: "#D5D7DD" }}
            >
              {HomeDescription}
            </p>
      ...
      <section
        className="relative max-w-7xl mx-auto flex flex-col md:grid md:grid-cols-2 items-center z-20 
      ...
      >
        ...
        <div className="relative w-full order-1">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, #F06058 0%, transparent 70%)",
            }}
          ></div>
        ...
        >
          <h2
            className="font-sora font-semibold text-[#F1F2F4]
          ...
          <p
            className="font-inter font-normal text-[#D5D7DD]
            /* Mobile: Matching paragraph size and leading */
            text-[14px] leading-[22px]
            /* Desktop resets */
            md:text-base md:leading-relaxed"
          >
            We are more than a digital agency. We are a laboratory of
            innovation. By fusing human-centric design with AI-driven SaaS
            products, we help businesses move from friction to flow. Our mission
            is to transform complex ideas into intelligent experiences that
      ...
      <section className="mx-6 md:m-32 text-center max-w-10xl md:mx-auto px-6 pt-8 pb-8">
        <h3
          className="font-sora text-[28px] md:text-[36px] font-semibold leading-[36px] md:leading-[48px] mb-8 md:mb-16"
          style={{ color: "#F1F2F4" }}
        >
      ...
      <section className="pt-12 pb-24 md:py-24 px-6 xl:px-[200px]">
        ...
        <div className="text-center">
          <h2
            className="mb-8 md:mb-12 text-[28px] md:text-[36px] font-semibold leading-[36px] md:leading-[48px]"
            style={{ color: "#F1F2F4", fontFamily: "Sora, sans-serif" }}
          >
          ...
          <div
            className="grid md:grid-cols-3 gap-12 md:gap-12 max-w-[1280px] mx-auto"
            style={{ gap: "48px" }}
          >
            {/* Card 1 */}
            <div className="bg-[#111214] p-9 rounded-[32px] text-left hover:border-zinc-700 transition">
              ...
              <h3
                className="text-[24px] font-bold text-[#F1F2F4] mb-4 tracking-[1px] leading-tight"
                style={{ fontFamily: "Sora, sans-serif" }}
              >
                AI-Driven Innovation
              </h3>
              <p
                className="text-[#D5D7DD] text-[16px]"
                style={{
                  overflow: "hidden",
              ...
              >
                Every solution is built with automation and intelligence at its
                core.
              </p>
            </div>
            ...
            <div className="bg-[#111214] p-9 rounded-[32px] text-left hover:border-zinc-700 transition">
              ...
              >
                Trusted by startups and enterprises across industries and
                continents.
              </p>
            </div>

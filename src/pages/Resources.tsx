        ...
        <div className="articles-container max-w-[1280px] mx-auto flex flex-col items-center gap-8 md:gap-12 px-4 md:px-0">
          ...
          <div className="self-stretch inline-flex flex-col justify-center items-center gap-12">
            <div className="articles-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 w-full max-w-[1280px] mx-auto">
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={saas} alt="SaaS concept collage" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
                    ...
                    <div className="flex-shrink-0 w-5 h-5 md:w-4 md:h-4 mt-1.5 flex items-center justify-center opacity-70 group-hover:opacity-100 transition-opacity">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={automation} alt="Automation and AI on laptop" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={person} alt="AI as teammate metaphor" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={executive} alt="Ending manual processes" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={woman} alt="Human in the loop conceptual UI" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={ui} alt="UI designer brainstorming" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={cloud} alt="Cloud strategy conceptual" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={young_asian} alt="AI chat interface metaphor" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={four} alt="AI impact on product teams" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={young_people} alt="UX design for agents" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={focus} alt="Focus concept collage" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={joyous} alt="Joyous speaker" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={programming} alt="Programming background" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">
              ...
              <a href="#" className="group w-full bg-zinc-800 rounded-[36px] inline-flex flex-col justify-start items-start overflow-hidden hover:bg-zinc-700/50 transition-colors">
                <img className="w-full h-56 object-cover" src={ai} alt="AI analysis team" />
                <div className="self-stretch p-6 flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch inline-flex justify-start items-start gap-4">

...
export default function Navbar() {
  ...
  const services = [
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M4.3845 8.55775V4.80775C4.3845 4.58342 4.46308 4.39275 4.62025 4.23575C4.77725 4.07858 4.96792 4 5.19225 4C5.41658 4 5.60725 4.07858 5.76425 4.23575C5.92142 4.39275 6 4.58342 6 4.80775V8.55775C6 8.78208 5.92142 8.97275 5.76425 9.12975C5.60725 9.28692 5.41658 9.3655 5.19225 9.3655C4.96792 9.3655 4.77725 9.28692 4.62025 9.12975C4.46308 8.97275 4.3845 8.78208 4.3845 8.55775ZM8.73075 9.852V0.80775C8.73075 0.583417 8.80925 0.39275 8.96625 0.23575C9.12325 0.0785832 9.314 0 9.5385 0C9.76283 0 9.9535 0.0785832 10.1105 0.23575C10.2675 0.39275 10.346 0.583417 10.346 0.80775V9.852C10.346 10.1212 10.2633 10.3231 10.098 10.4578C9.9325 10.5924 9.74692 10.6597 9.54125 10.6597C9.33558 10.6597 9.14909 10.5924 8.98175 10.4578C8.81442 10.3231 8.73075 10.1212 8.73075 9.852ZM0 11.9943V8.80775C0 8.58342 0.0785 8.39275 0.2355 8.23575C0.3925 8.07858 0.58325 8 0.80775 8C1.03208 8 1.22275 8.07858 1.37975 8.23575C1.53675 8.39275 1.61525 8.58342 1.61525 8.80775V11.9943C1.61525 12.2636 1.53258 12.4655 1.36725 12.6C1.20175 12.7347 1.01617 12.802 0.8105 12.802C0.604667 12.802 0.418167 12.7347 0.251 12.6C0.0836669 12.4655 0 12.2636 0 11.9943ZM1.08525 17.8577C0.86175 17.8577 0.707334 17.7562 0.622 17.553C0.536833 17.3498 0.575667 17.1668 0.7385 17.004L4.646 13.0962C4.791 12.9514 4.9695 12.8707 5.1815 12.854C5.39367 12.8373 5.58183 12.9014 5.746 13.0462L8.73075 15.6115L15.4845 8.85775H13.6923C13.5506 8.85775 13.4318 8.80975 13.336 8.71375C13.2402 8.61775 13.1923 8.49883 13.1923 8.357C13.1923 8.21517 13.2402 8.0965 13.336 8.001C13.4318 7.9055 13.5506 7.85775 13.6923 7.85775H16.3845C16.6133 7.85775 16.8052 7.93517 16.96 8.09C17.1148 8.24483 17.1923 8.43667 17.1923 8.6655V11.3577C17.1923 11.4994 17.1443 11.6182 17.0483 11.714C16.9523 11.8098 16.8333 11.8577 16.6915 11.8577C16.5497 11.8577 16.431 11.8098 16.3355 11.714C16.24 11.6182 16.1923 11.4994 16.1923 11.3577V9.5655L9.2885 16.4693C9.1435 16.6141 8.965 16.6948 8.753 16.7115C8.54083 16.7282 8.35267 16.6641 8.1885 16.5193L5.20375 13.954L1.446 17.7115C1.40317 17.7522 1.3495 17.7867 1.285 17.815C1.2205 17.8435 1.15392 17.8577 1.08525 17.8577Z"
            fill="#F1F2F4"
          />
        </svg>
      ),
  ...
  return (
    <>
      <nav
        className={`${isOnServicePage ? "fixed md:absolute" : "fixed"} top-0 w-full z-50 text-white font-['Inter'] transition-all duration-300 ${isScrolled ? "bg-[#0E0F11]/84 md:bg-[#0B0C0E]/85 backdrop-blur-md" : "bg-transparent"}`}
      >
      ...
      {isServicesOpen && (
        ...
        >
          <div className="max-w-[1280px] mx-auto px-6 py-6 h-full w-full grid grid-cols-3 gap-x-12 overflow-y-auto">

...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`fixed top-0 w-full z-50 text-white font-['Inter'] transition-all duration-300 ${
      ...
      {isServicesOpen && (
        <div 
          ref={dropdownRef}
          className="hidden md:flex fixed top-[76px] left-0 w-full z-50 bg-black/50 backdrop-blur-md text-white font-['Inter'] border-t border-white/10 justify-center"
          style={{ 
            height: '384px',
          }}
        >
